...
const (
	finalizerString = "finalizers.elasticache.services.k8s.aws/UserGroup"
)
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.UserGroup{}),
	}
