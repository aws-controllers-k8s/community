...
import (
	...
	svcapitypes "github.com/aws/aws-controllers-k8s/services/petstore/apis/v1alpha1"
)

const (
	petFinalizerString = "finalizers.petstore.services.k8s.aws/Pet"
)
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.Pet{}))
	return &diffReporter
}
...
func (d *resourceDescriptor) IsManaged(
	...
	//
	// return k8sctrlutil.ContainsFinalizer(obj, petFinalizerString)
	return containsFinalizer(obj, petFinalizerString)
}
...
func (d *resourceDescriptor) MarkManaged(
	...
	k8sctrlutil.AddFinalizer(obj, petFinalizerString)
}
...
func (d *resourceDescriptor) MarkUnmanaged(
	...
	k8sctrlutil.RemoveFinalizer(obj, petFinalizerString)
}
