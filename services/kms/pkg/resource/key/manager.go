...
// +kubebuilder:rbac:groups=kms.services.k8s.aws,resources=keys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kms.services.k8s.aws,resources=keys/status,verbs=get;update;patch
