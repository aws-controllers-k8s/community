...
// +kubebuilder:rbac:groups=kms.services.k8s.aws,resources=grants,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kms.services.k8s.aws,resources=grants/status,verbs=get;update;patch
