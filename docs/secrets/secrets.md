...
![User Flowchart](images/rds-db-instance-creation-sequence-user-flowchart.png)
...
![Sequence Diagram for RDS DB Instance Creation](images/rds-db-instance-creation-sequence-sequence-diagram.png)
