...
func Generate{{ .CRD.Ops.GetAttributes.InputRef.Shape.ShapeName }}(cr *svcapitypes.{{ .CRD.Names.Camel }}) *svcsdk.{{ .CRD.Ops.GetAttributes.InputRef.Shape.ShapeName }} {
	res := preGenerate{{ .CRD.Ops.GetAttributes.InputRef.Shape.ShapeName }}(cr, &svcsdk.{{ .CRD.Ops.GetAttributes.InputRef.Shape.ShapeName }}{})
{{ GoCodeGetAttributesSetInput .CRD "cr" "res" 1 }}
	return postGenerate{{ .CRD.Ops.GetAttributes.InputRef.Shape.ShapeName }}(cr, res)
}
